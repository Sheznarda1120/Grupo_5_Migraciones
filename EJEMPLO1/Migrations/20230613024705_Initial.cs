        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Venta_encabezadoid = table.Column<int>(type: "int", nullable: false),
                    cantidad = table.Column<int>(type: "int", nullable: false),
                    precio = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_venta_detalle_venta_Encabezado_Venta_encabezadoid",
                        column: x => x.Venta_encabezadoid,
                        principalTable: "venta_Encabezado",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_venta_detalle_Venta_encabezadoid",
                table: "venta_detalle",
                column: "Venta_encabezadoid");
